INSERT default::User {username := 'user', password := 'pass', first_name := 'Test', last_name := 'Testerton', is_logged_in := false};
INSERT default::User {username := 'user1', password := 'pass',first_name := 'John', last_name := 'Doe', is_logged_in := false};
INSERT default::User {username := 'user2', password := 'pass', first_name := 'Fred', last_name := 'Flintstone', is_logged_in := false};
